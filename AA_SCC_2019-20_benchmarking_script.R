...
dat <- readRDS("Z:/Group_work/Alex/Encrypted/Alex/Adult Asthma/SCC 2019-2020/Data/tidyData/AA_SCC_2019-20_clean_data_2020-06-24.RDS")
...
quartz1 <- matrix(data = NA, nrow = 3, ncol = 4)
...
quartz_fmt <- matrix(data = NA, nrow = 3, ncol = 4)
...
colnames(quartz_fmt) <- c("statistic", "BM_PEF_1hour_perc", "BM_RSR_24hour_perc", "BM_steroids_1hour_perc")

quartz_fmt <- as.data.frame(quartz_fmt)

write.csv(quartz_fmt, file =
  "Z:/Group_work/PS_AA/Adult Asthma/SCC 2019-2020/Data/dataStore/AA_SCC_2019-2020_benchmarking_quartiles_2020-06-26.csv",
          row.names = FALSE)
...
bmk <- bmk %>% add_column(BM_PEF_1hour_colour = bmk$BM_PEF_1hour_colour_end, .after = "BM_PEF_1hour_perc") %>%
  ...
  select(-BM_PEF_1hour_colour_end, -BM_RSR_24hour_colour_end, -BM_steroids_1hour_colour_end)
...
write.csv(bmk, file =
"Z:/Group_work/PS_AA/Adult Asthma/SCC 2019-2020/Data/dataStore/AA_SCC_2019-2020_benchmarking_2020-06-26.csv",
  row.names = FALSE)
